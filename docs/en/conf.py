...
html_theme_options = {
    'repository_url': 'https://github.com/InternLM/InternLM',
...
man_pages = [(master_doc, 'internlm', 'InternLM Documentation', [author], 1)]
